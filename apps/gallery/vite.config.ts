...
export default defineConfig({
  resolve: {
    ...
    alias: {
      ...
      '@pineappleui/dropdown-menu/': `${path.resolve(galleryDir, '../../packages/dropdown-menu/src')}/`,
      '@pineappleui/dropdown-menu': path.resolve(galleryDir, '../../packages/dropdown-menu/src/index.ts'),
