...
- [#63](https://github.com/davidz-repo/pineapple-design-system/pull/63) [`f6d79fa`](https://github.com/davidz-repo/pineapple-design-system/commit/f6d79faa7817c5b1acd9521062af354475a696d3) Thanks [@davidz-repo](https://github.com/davidz-repo)! - `TextField.Root` and `TextField.Slot` now carry a described prop overlay, so all
